            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 ${
                  darkMode 
                    ? 'bg-gray-800 bg-opacity-50 border-gray-600 border-opacity-50 focus:border-[#65000b] focus:ring-[#65000b] focus:ring-opacity-20' 
                    : 'bg-gray-50 bg-opacity-50 border-gray-300 border-opacity-50 focus:border-[#d3011c] focus:ring-[#d3011c] focus:ring-opacity-20'
                }`}
              />
            </div>
              ...
              <div className="relative">
                ...
                <label 
                  ...
                  className={`flex items-center justify-center w-5 h-5 rounded-md border-2 cursor-pointer transition-all duration-200 ${
                    localField.required
                      ? darkMode 
                        ? 'bg-[#65000b] border-[#65000b]' 
                        : 'bg-[#d3011c] border-[#d3011c]'
                      : darkMode
                        ? 'border-gray-600 hover:border-[#65000b]'
                        : 'border-gray-300 hover:border-[#d3011c]'
                  }`}
                >
                  {localField.required && (
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 border-2 border-dashed rounded-xl transition-all duration-200 font-medium ${
                      darkMode 
                        ? 'border-gray-600 border-opacity-50 hover:border-[#65000b] hover:border-opacity-50 text-[#65000b] hover:bg-[#65000b] hover:bg-opacity-5' 
                        : 'border-gray-300 border-opacity-50 hover:border-[#d3011c] hover:border-opacity-50 text-[#d3011c] hover:bg-[#d3011c] hover:bg-opacity-5'
                    }`}
                  >
        ...
        <div className={`px-6 py-4 border-t flex space-x-3 flex-shrink-0 ${
          ...
          <button
            ...
            className={`flex-1 py-3 px-6 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-lg ${
              darkMode 
                ? 'bg-[#65000b] text-white hover:bg-[#7a0010]' 
                : 'bg-[#d3011c] text-white hover:bg-[#e8112c]'
            }`}
          >
            Save Changes
          </button>
