          ...
          {form.fields.map((field, index) => (
            <div
              ...
              className={`p-4 rounded-lg border transition-all ${
                draggedOver === index 
                  ? darkMode 
                    ? 'border-primary-light bg-gray-700/70'  // Changed from cyan-500 to primary-light
                    : 'border-primary-light bg-red-100/30'   // Changed from purple-400 to primary-light, bg to red-100/30
                  : darkMode 
                    ? 'border-gray-700 bg-gray-700/50 hover:bg-gray-700/70'  // Kept dark mode same
                    : 'border-gray-200 bg-white/80 hover:bg-white/90 backdrop-blur-sm shadow-md' // Changed to off-white
              } group`}
            >
