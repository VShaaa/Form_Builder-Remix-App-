...
const FieldPalette = ({ darkMode }) => {
  ...
  return (
    <div className={`w-70 border-r backdrop-blur-sm ${
      darkMode 
        ? 'bg-gray-800/95 border-gray-700 shadow-[inset_-1px_0_0_0_#65000b]' 
        : 'bg-white/80 border-gray-200/50 shadow-[inset_-1px_0_0_0_#d3011c]'
      }`}>
          ...
          return (
            ...
            >
              <div className={`flex items-center justify-center w-8 h-8 rounded-md transition-colors ${
                ...
                <IconComponent 
                  size={16} 
                  className={darkMode ? 'text-[#65000b]' : 'text-[#d3011c]'} 
                />
              </div>
